...
class BlackTestCase(unittest.TestCase):
    ...
    def test_string_quotes(self) -> None:
        ...
        black.assert_equivalent(source, actual)
        black.assert_stable(source, actual, black.FileMode())
        single_mode = black.FileMode(single_quotes=True)
        single_source, single_expected = read_data("string_single_quotes")
        single_actual = fs(single_source, mode=single_mode)
        self.assertFormatEqual(single_expected, single_actual)
        black.assert_equivalent(source, actual)
        black.assert_stable(single_source, single_actual, mode=single_mode)
